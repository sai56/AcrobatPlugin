...
ACCB1 ASBool ACCB2 PluginInit(void){
	...
	AVIcon myIcon = (AVCursor)LoadBitmap(gHINSTANCE, MAKEINTRESOURCE(IDB_BITMAP2));
	...
	AVExecuteProc ExecProcPtr = ASCallbackCreateProto(AVExecuteProc, &LoadGooglePage);
	AVToolButtonSetExecuteProc(MyButton, ExecProcPtr, NULL);


	//Set a button's help text
	const char * helpText = "Google and UploadFile";
